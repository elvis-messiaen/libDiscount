...
<div class="container">
	<div class="row">
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Librairie</a>
			</div>
		</div>
		<div class="col-md-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Annonces</a>
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Adresses</a>
			</div>
		</div>
		<div class="col-md-3">
			<div class="d-flex justify-content-around flex-wrap">
		...
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Livres</a>
			</div>
		</div>
		<div class="col-md-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="${pageContext.request.contextPath}/gestionUtilisateurs">Utilisateurs</a>
			</div>
		</div>
	</div>
		<div class="row">
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Création de catégorie</a>
			</div>
		</div>
	</div>
</div>	
