...
<body>
	...
	<!------------------------------- navbar --------------------------------->
		...
		<c:choose>
   			<c:when test="${user.role eq 'CLIENT'}">
				<a class="dropdown-item " href="${pageContext.request.contextPath }/MonCompte">Mon compte client</a>
			</c:when> 
  		    <c:when test="${user.role eq 'VENDEUR'}">
  		    	<a class="dropdown-item " href="${pageContext.request.contextPath }/MonCompteVendeur">Mon compte vendeur</a>
  		    </c:when> 
		</c:choose>
		<c:choose>			
	...
	<hr>
		...
		<div><c:out value="bonjour ${user.nom} ${user.prenom}" default=""/> 
		</div>
		</c:if>	
		</div>
...
<!----------------------------------fin----------------------------------------------------------->
	<div class="container">
		<article>
			<a href=""> <img class="promo"
				src="${pageContext.request.contextPath}/resources/img/promo.jpg"
				alt="livre">
			</a>
		</article>
		<h2 class="d-flex justify-content-center">Nos produits</h2>
		...
		<div class="d-flex justify-content-around flex-wrap">
			...
			<div class="item-box ">
				<div class="d-flex justify-content-around">
					<img class="h-25"
						src="${pageContext.request.contextPath}/resources/img/livre.png"
						alt="livre">
					<div class="thumbnail m-5">Remise</div>
				</div>
				<div class="titreprod">Titre</div>
				<div class="descripProd">Description</div>
				<div class="cartProd">
					<a href="Panier/" class="fas fa-cart-plus fa-2x float-left "></a>
					<div class="priceProd">prix</div>
				</div>
			</div>
			...
			<div class="item-box ">
				<div class="d-flex justify-content-around">
					<img class="h-25"
						src="${pageContext.request.contextPath}/resources/img/livre.png"
						alt="livre">
					<div class="thumbnail thumbnail m-5 ">Remise</div>
				</div>
				<div class="titreprod">Titre</div>
				<div class="descripProd">Description</div>
				<div class="cartProd">
			...
			<div class="item-box ">
				<div class="d-flex justify-content-around">
					<img class="h-25"
						src="${pageContext.request.contextPath}/resources/img/livre.png"
						alt="livre">
					<div class="remise m-5">Remise</div>
				</div>
				<div class="titreprod">Titre</div>
				<div class="descripProd">Description</div>
				<div class="cartProd">
...
<!-- 			ï¿½ 2020 Copyright: <a href="https://libDiscount.com"> -->
<!-- 				libDiscount.com</a> -->
<!-- 		</div> -->
