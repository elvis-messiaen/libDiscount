...
<script
	...
	crossorigin="anonymous"></script>
<link href="<c:url value="/resources/css/addElement.css"/>"
	rel="stylesheet">
</head>
<body>
	<!------------------------------- navbar --------------------------------->
		...
		<div class="row">
			<div class=" col-4 d-flex h3">
				...
				<c:if test="${ !empty user.nom}">
					<div>
						<c:out value="bonjour ${user.nom}" default="" />
					</div>
				</c:if>
			</div>
	...
	<!----------------------------------fin----------------------------------------------------------->	
	<h1 class="m-3">Mes Livres</h1>
	<div class="container  ">
		<div class="row justify-content-around">
			<div class="borderPointille col-md-5 d-flex flex-wrap mt-4 my-5 ">
				<div class="d-flex mx-3">
					<a href="${pageContext.request.contextPath}/AjouterLivre" class="far fa-plus-square fa-2x my-5"></a>
				</div>
				<div class="colorAdresse h3 d-flex mx-3 my-5">Ajouter un
					livre</div>
			</div>
			...
			<c:forEach items="${listeLivre}" var="livre">
				<div
					...
					<div class="d-flex flex-column ">
						...
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.nivScolaire} " />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.isbb} " />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.dateEdition} " />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.maisonEdition} " />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.prixUnitaire} " />
						</div>	
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${livre.image} " />
						</div>															
						<div class="supprimerAdresse h3">
							<div class="row justify-content-around">
						<div class="col-4">
							<a href="${pageContext.request.contextPath}/supprimerAdresseVendeur/${livre.idAdresse }">supprimer</a>
						</div>

						<div class="col-4">
							<a href="${pageContext.request.contextPath}/modifierAdresseVendeur/${livre.idAdresse }">modifier</a>
						</div>
						</div>
						</div>
					</div>
