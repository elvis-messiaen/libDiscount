...
<div class="container">
		...
		<div class="row">
			<div class=" col-12 conteneurFormulaire">
					<form action="${pageContext.request.contextPath}/modifierAdrVendeur" method="post">
	
						<div class= "divTitle">
						<h5>Modifier une Adresse :</h5>
						</div>
						
						<input type="hidden" name = "idAdresse" value="${adresseVendeur.idAdresse}"/>
					

						<div class="col-12 divInput">
						<label for="numVoie">Numéro de voie :</label>
						<input type="text" name = "numVoie" value="${adresseVendeur.numVoie}"/>
						</div>
						
						<div class="col-12 divInput">
						<label for="nomVoie">Nom de voie :</label>
						<input type="text" name = "nomVoie"  value="${adresseVendeur.nomVoie}"/>
						</div>
						
						<div class="col-12 divInput">
						<label for="codePostal">Code postal :</label>
						<input type="text" name = "codePostal"  value="${adresseVendeur.codePostal}"/>
						</div>
						
						<div class="col-12 divInput">
						<label for="ville">Ville :</label>
						<input type="text" name = "ville"  value="${adresseVendeur.ville}"/>
						</div>
