...
<!----------------------------------fin----------------------------------------------------------->
	<h1 class="m-3">Annonce</h1>
	<div class="container">
		<div class="row">
			<div class="borderPointille col-md-5 d-flex flex-wrap mt-4 my-5 ">
			<div class="d-flex mx-3">
			<a href=""class="far fa-plus-square fa-2x my-5"></a>
			</div>
			<div class="colorAdresse h3 d-flex mx-3 my-5">Ajouter une annonce</div>
			</div>
			
			<div class="borderSolid col-md-5 offset-1  d-flex flex-wrap mt-4 my-5">
			<div class="d-flex flex-column">
			<div class="mt-4 h3 mr-3 d-flex "> Titre</div>
			<div class="mt-1 h3 mr-3 d-flex ">Remise</div>
			<div class="mt-1 h3 mr-3 d-flex ">Prix total</div>

			<div class="marSupp h3"><a href="">supprimer</a></div>
			</div>
			</div>
			<div class="borderSolid col-md-5  d-flex flex-wrap mt-4 my-5">
