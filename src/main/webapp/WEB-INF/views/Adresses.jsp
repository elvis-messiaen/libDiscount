...
<body>
	...
	<div class="container  ">
		<div class="row justify-content-around">
			...
			<c:forEach items="${listeAdrVendeur}" var="adres">
				<div
					...
					<div class="d-flex flex-column ">
						...
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${adres.numVoie} ${adres.nomVoie}" />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${adres.codePostal} ${adres.ville}" />
						</div>
						...
						<div class="supprimerAdresse h3">
							<div class="row justify-content-around">
						<div class="col-4">
							<a href="${pageContext.request.contextPath}/supprimerAdresseVendeur/${adres.idAdresse }">supprimer</a>
						</div>

						<div class="col-4">
							<a href="${pageContext.request.contextPath}/modifierAdresseVendeur/${adres.idAdresse }">modifier</a>
						</div>
						</div>
						</div>
					</div>
