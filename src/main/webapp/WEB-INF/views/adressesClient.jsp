...
<body>
	...
	<!----------------------------------fin----------------------------------------------------------->	
	<h1 class="m-3">Mes adresses</h1>
	<div class="container">
		<div class="row justify-content-around">
			<div class="borderPointille col-md-5 d-flex flex-wrap mt-4 my-5 ">
				<div class="d-flex mx-3">
					<a href="${pageContext.request.contextPath}/AjouterAdresses" class="far fa-plus-square fa-2x my-5"></a>
				</div>
				<div class="colorAdresse h3 d-flex mx-3 my-5">Ajouter une
					adresse</div>
			</div>
			<c:forEach items="${listeAdrClient}" var="adresse">
				<div
					class="borderSolid col-md-5   d-flex flex-wrap  mt-4 my-5">
					<div class="d-flex flex-column ">
						<div class="mt-4 h4 mr-3 d-flex ">${user.nom}${user.prenom}</div>

						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${adresse.numVoie} ${adresse.nomVoie}" />
						</div>
						<div class="mt-1 h4 mr-3 d-flex ">
							<c:out value="${adresse.codePostal} ${adresse.ville}" />
						</div>
						...
						<div class="supprimerAdresse h3">
                            <div class="row justify-content-around">
                        <div class="col-4">
                            <a href="${pageContext.request.contextPath}/supprimerAdresseClient/${adresse.idAdresse}">supprimer</a>
                        </div>

                        <div class="col-4">
                            <a href="${pageContext.request.contextPath}/modifierAdresseClient/${adresse.idAdresse}">modifier</a>
                        </div>
                        </div>
                        </div>
                    </div>
