...
<div class="container">
	<div class="row">
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="${pageContext.request.contextPath}/Librairie">Librairie</a>
			</div>
		</div>
		<div class="col-md-3 ">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="">Annonce</a>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="${pageContext.request.contextPath}/Adresses">Adresses</a>
			</div>
		</div>
		<div class="col-md-3 ">
			<div class="d-flex justify-content-around flex-wrap">
	...
	<div class="row">
		<div class="col-md-3 offset-3">
			<div class="d-flex justify-content-around flex-wrap">
				<a class="BoxMonCompte" href="${pageContext.request.contextPath}/Livre">Livres</a>
			</div>
		</div>
	</div>
</div>	
